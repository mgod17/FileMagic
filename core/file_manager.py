...
class FileManager:
        ...
        for archivo in os.listdir(self.folder_path):
            ...
            if os.path.isfile(archivo_path):
                try:
                    ...
                    print(f"Archivo: {archivo}, Tipo: {tipo_archivo}")

                    if tipo_archivo in subcarpetas:
                       nombre_archivo = os.path.basename(archivo_path)
                       destino_path = os.path.join(carpeta_organizados, tipo_archivo, nombre_archivo)
                       print(f"Moviendo a: {destino_path}")
    ...
    def obtener_tipo_archivo(self, archivo_path):
        ...
        # Obtener la extensión del archivo
            ...
            print(f"Archivo: {archivo_path}, Tipo: {tipo_carpeta}")
